...
if __name__ == "_main_":
    person = American("Chandu",24)
    reason = NewYorker("Vishnu",24,"for masters")
...
# to create a class with name rectangle an to fing the area of it 
...
print(same_string("hello chnadu"))
print(same_string("hello harish"))
